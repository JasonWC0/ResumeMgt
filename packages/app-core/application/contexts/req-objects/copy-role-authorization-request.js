 ...
 *
 * File: copy-role-authorization-request.js
 * Project: @erpv3/app-core
 * File Created: 2022-04-18 05:08:22 pm
 ...
 */
class CopyRoleAuthorizationRequest extends BaseBundle {
  /**
* @constructor
*/
  constructor() {
    ...
    this.companyId = '';
    /**
     * @type {string} roleAuthorizationId
     * @description 複製角色權限Id
     * @member
     */
    this.roleAuthorizationId = '';
    /**
    * @type {string} name
    * @description 員工角色名稱
    * @member
  ...
  checkRequired() {
    new CustomValidator()
      ...
      .nonEmptyStringThrows(this.roleAuthorizationId, coreErrorCodes.ERR_ROLE_AUTHORIZATION_ID_EMPTY)
...
module.exports = CopyRoleAuthorizationRequest;
