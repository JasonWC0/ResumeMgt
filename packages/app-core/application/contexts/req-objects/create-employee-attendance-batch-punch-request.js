...
/**
* @class
* @classdesc Create employee attendance batch punch request
*/
class CreateEmployeeAttendanceBatchPunchRequest extends BaseBundle {
  /**
  * @constructor
  */
  constructor() {
...
module.exports = CreateEmployeeAttendanceBatchPunchRequest;
