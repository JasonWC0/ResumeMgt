 ...
 *
 * File: v1-review-submit.spec.js
 * Project: @erpv3/backend
 * File Created: 2022-05-13 03:27:28 pm
...
describe('審核送出', () => {
  ...
  describe('成功', () => {
    test("[200] 審核送出-成功", async (done) => {
      ...
      expect(statusRes.nowReviewRole).toEqual([1, 3]);
