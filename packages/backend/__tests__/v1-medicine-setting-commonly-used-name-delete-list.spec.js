 ...
 *
 * File: v1-medicine-setting-commonly-used-name-delete-list.spec.js
 * Project: @erpv3/backend
 * File Created: 2022-08-08 04:50:12 pm
...
describe('刪除用藥常用名稱', () => {
  ...
  describe('成功', () => {
    test('[200] 刪除用藥常用名稱-成功', async (done) => {
      const _data = {
        companyId: testCompanyData[0]._id.toString(),
        name: '陳醫生,李醫生',
      }
      ...
      expect(dbData.name).toEqual(['王醫生', '張醫生']);
      done();
    });
  });
});
