 ...
 *
 * File: v1-care-plan-delete-onlyone-history.spec.js
...
describe('刪除僅一筆歷史照顧計畫', () => {
  ...
  describe('成功', () => {
    test('[200] 刪除僅一筆歷史照顧計畫-成功', async (done) => {
      ...
      expect(careRes2.valid).toBe(true);
      expect(careRes2.planEndDate).toBe(null);
